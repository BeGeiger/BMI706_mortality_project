...
Generate all mortality and populations files for the years 1968-1988 by executing the script generate_files.sh via
...
This will generate the following data in the population subfolder:
...
This will generate the following data in the mortality subfolder:
